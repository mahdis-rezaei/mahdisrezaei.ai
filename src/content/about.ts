/**
 * About-page content (four tabs + closing band), from the approved spec.
 ...
 *
 * Meta specifics follow PRD §13: internal codenames are omitted; figures are
 * included per the owner's explicit spec.
 */
...
export const aboutPage = {
    ...
    chapters: [
      {
        ...
        narrative: [
          "Born in a small town in northeast Iran, into a family of builders. My parents had little formal schooling — my mother never learned to read — and still they started business after business from nothing. I grew up at the kitchen table while they sketched the next one, and I understood early that the map I'd been handed was smaller than the one I wanted.",
        ],
  ...
  career: {
    ...
    cards: [
      ...
      },
      {
        ...
        body: "Not a chatbot — an evidence-grounded layer where an investigator asks in plain language and gets case-specific reasoning, recommended actions, and the evidence behind them. I set a high trust bar: every answer grounded in a source of truth, human confirmation before consequential actions, safe failure.",
  ...
  howIWork: {
    ...
    lede: "Each principle is mine. Each quote is real — a former colleague, anonymized to their role.",
    principles: [
      {
  ...
  offClock: {
    ...
    practices: [
      ...
      {
        title: "Journaling",
        body: "Almost every morning since 2015 — not a diary, a conversation. I interview myself, argue with my own fear, get to the actual question under the noise.",
