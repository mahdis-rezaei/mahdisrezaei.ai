...
/**
 * Companies before Meta, shown as a compact arc on the Career highlights tab
 * (the full detail lives in Career history). Most recent first.
 */
export const careerEarlier = [
  {
    company: "Amazon",
    role: "Principal TPM, Ring",
    period: "2019 to 2022",
    note: "Owned Ring's subscription business and P&L for 14M+ customers across 20+ markets.",
  },
  {
    company: "GoodRx",
    role: "Senior TPM",
    period: "2019",
    note: "Owned the price page, the most important page on the prescription-savings marketplace.",
  },
  {
    company: "GlobeTax Services",
    role: "Senior TPM",
    period: "2017 to 2019",
    note: "Owned eCerts, self-service international tax certification for financial institutions.",
  },
  {
    company: "Blue Apron",
    role: "TPM",
    period: "2017",
    note: "Ran the information systems that carried the company through its IPO year.",
  },
  {
    company: "GroundControl",
    role: "TPM",
    period: "2015 to 2017",
    note: "Ran the engineering team for shared-device fleet automation at a fifteen-person startup.",
  },
];
